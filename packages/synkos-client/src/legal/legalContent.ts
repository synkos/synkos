...
// Content is generated lazily from app config to avoid reading config before boot.
// ─────────────────────────────────────────────────────────────────────────────

export function getLegalContent(locale: string): LegalContent {
  const c = getClientConfig();
  const appName = c.name;
  const legalEntityName = c.company.legalName;
  const contactEmail = c.links.contactEmail;
  const supportEmail = c.links.supportEmail;
  const websiteUrl = c.links.website;
  const country = c.company.country;
  const jurisdiction = c.company.jurisdiction;

  const enUS: LegalContent = {
    terms: {
      title: 'Terms of Service',
      lastUpdated: 'April 12, 2026',
      intro: `These Terms of Service ("Terms") govern your access to and use of ${appName}, operated by ${legalEntityName} ("we", "us", or "our"). By creating an account or using the app, you agree to be bound by these Terms.`,
      sections: [
        {
          title: '1. Acceptance of Terms',
          paragraphs: [
            `By accessing or using ${appName}, you confirm that you are at least 16 years old and that you accept these Terms in full. If you do not agree, please do not use the app.`,
        ...
        },
        {
          ...
          paragraphs: [
            `${appName} is a mobile application that allows users to catalog, grade, and track the value of trading card game (TCG) collections, primarily Pokémon cards. Features include card scanning via camera, collection management, grade tracking, and market price estimates.`,
        ...
        },
        {
          ...
          paragraphs: [
            ...
            `You may delete your account at any time by contacting us at ${supportEmail}. Upon deletion, your data will be removed in accordance with our Privacy Policy.`,
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            `All content, design, code, and trademarks within ${appName} are the property of ${legalEntityName} or its licensors and are protected by applicable intellectual property laws.`,
        ...
        },
        {
          ...
          paragraphs: [
            `Card grades, condition assessments, and value estimates provided by ${appName} are generated automatically using image recognition and machine learning. They are approximate and may not reflect official grading standards (e.g., PSA, BGS, CGC).`,
        ...
        },
        {
          ...
          paragraphs: [
            `To the maximum extent permitted by applicable law, ${legalEntityName} shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising out of or related to your use of the app.`,
        ...
        },
        {
          ...
          paragraphs: [
            `These Terms are governed by and construed in accordance with the laws of ${jurisdiction}, without regard to conflict of law principles. Any disputes shall be subject to the exclusive jurisdiction of the courts of ${country}.`,
        ...
        },
        {
          title: '11. Contact',
          paragraphs: [
            `If you have any questions about these Terms, please contact us at ${contactEmail} or visit ${websiteUrl}.`,
          ],
        },
      ],
    },
    ...
    privacy: {
      ...
      lastUpdated: 'April 12, 2026',
      intro: `This Privacy Policy explains how ${legalEntityName} ("we", "us", or "our") collects, uses, and protects your personal data when you use ${appName}. We are committed to protecting your privacy in accordance with the EU General Data Protection Regulation (GDPR) and other applicable laws.`,
      sections: [
        {
          title: '1. Data Controller',
          paragraphs: [
            `The data controller responsible for your personal data is ${legalEntityName}. You can contact us at ${contactEmail}.`,
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            ...
            `To exercise any of these rights, contact us at ${contactEmail}. We will respond within 30 days.`,
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            `${appName} is not directed at children under the age of 16. We do not knowingly collect personal data from children. If you believe a child has provided us with personal data, please contact us immediately at ${contactEmail} and we will delete it promptly.`,
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            `For any privacy-related questions or to exercise your rights, contact us at ${contactEmail}.`,
  ...
  const esES: LegalContent = {
    terms: {
      ...
      intro: `Estos Términos de Servicio ("Términos") regulan el acceso y uso de ${appName}, operado por ${legalEntityName} ("nosotros" o "nuestra empresa"). Al crear una cuenta o utilizar la aplicación, aceptas quedar vinculado por estos Términos.`,
      sections: [
        {
          title: '1. Aceptación de los Términos',
          paragraphs: [
            `Al acceder o utilizar ${appName}, confirmas que tienes al menos 16 años y que aceptas íntegramente estos Términos. Si no estás de acuerdo, por favor no uses la aplicación.`,
        ...
        },
        {
          ...
          paragraphs: [
            ...
            `Puedes eliminar tu cuenta en cualquier momento contactando con nosotros en ${supportEmail}. Tras la eliminación, tus datos serán suprimidos conforme a nuestra Política de Privacidad.`,
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            `Todo el contenido, diseño, código y marcas comerciales dentro de ${appName} son propiedad de ${legalEntityName} o de sus licenciantes y están protegidos por las leyes de propiedad intelectual aplicables.`,
        ...
        },
        {
          ...
          paragraphs: [
            `Los grades de cartas, valoraciones de estado y estimaciones de valor proporcionadas por ${appName} se generan automáticamente mediante reconocimiento de imagen e inteligencia artificial. Son aproximados y pueden no reflejar los estándares oficiales de gradeo (p. ej., PSA, BGS, CGC).`,
        ...
        },
        {
          ...
          paragraphs: [
            `En la medida máxima permitida por la ley aplicable, ${legalEntityName} no será responsable de ningún daño indirecto, incidental, especial, consecuente o punitivo derivado del uso de la app.`,
        ...
        },
        {
          ...
          paragraphs: [
            `Estos Términos se rigen e interpretan de acuerdo con las leyes de ${jurisdiction}, sin consideración a los principios de conflicto de leyes. Cualquier controversia quedará sometida a la jurisdicción exclusiva de los tribunales de ${country}.`,
        ...
        },
        {
          title: '11. Contacto',
          paragraphs: [
            `Si tienes alguna pregunta sobre estos Términos, contáctanos en ${contactEmail} o visita ${websiteUrl}.`,
          ],
        },
      ],
    },
    ...
    privacy: {
      ...
      lastUpdated: '12 de abril de 2026',
      intro: `Esta Política de Privacidad explica cómo ${legalEntityName} ("nosotros" o "nuestra empresa") recopila, utiliza y protege tus datos personales cuando usas ${appName}. Nos comprometemos a proteger tu privacidad conforme al Reglamento General de Protección de Datos (RGPD) de la UE y otras leyes aplicables.`,
      sections: [
        {
          title: '1. Responsable del Tratamiento',
          paragraphs: [
            `El responsable del tratamiento de tus datos personales es ${legalEntityName}. Puedes contactarnos en ${contactEmail}.`,
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            ...
            `Para ejercer cualquiera de estos derechos, contáctanos en ${contactEmail}. Responderemos en un plazo de 30 días.`,
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            `${appName} no está dirigida a menores de 16 años. No recopilamos conscientemente datos personales de menores. Si crees que un menor nos ha proporcionado datos personales, contáctanos de inmediato en ${contactEmail} y los eliminaremos sin demora.`,
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            `Para cualquier consulta relacionada con la privacidad o para ejercer tus derechos, contáctanos en ${contactEmail}.`,
