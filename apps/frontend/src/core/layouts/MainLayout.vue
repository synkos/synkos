...
import DeletionBanner from 'src/core/components/navigation/DeletionBanner.vue';
import AppMenuDrawer from 'src/core/components/navigation/AppMenuDrawer.vue';
